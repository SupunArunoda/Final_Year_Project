...
message_file = './data/testdata.csv'
...
vol_average.run_volume_average(message_file=message_file,session_file=session_file,no_of_lines=200,time_delta=1)

# ex_type_based=ExecutionTypeTest()
# ex_type_based.run_execution_type(message_file=message_file,session_file=session_file,no_of_lines=10000,time_delta=300)
